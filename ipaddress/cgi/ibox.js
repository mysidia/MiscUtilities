...
var close_ibox_path="/images/closelabel.gif";
var close_ibox_html="";
function init_ibox(){
...
for(var i=0;i<=opacity_level;i++){setTimeout("setIboxOpacity('ibox_w',"+i+")",20*i);}
box_w.style.display="";
...
strHTML+="</div>";
strHTML+="<div id=\"ibox_wrapper\" class=\"ibox_wrapper\" style=\"display:none\">";
strHTML+="<div id=\"ibox_content\"></div>";
strHTML+="<div id=\"ibox_footer_wrapper\"><div id=\"ibox_close\" style=\"float:right;\">";
strHTML+="<a id=\"ibox_close_a\" href=\"javascript:void(null);\" >Close this window</a></div>";
